          ...
          <div class="col-md-12">
            <div class="card card-user">
              ...
              <div class="card-body">
                ...
                <form action="/slider-create-material" method="POST">
                    <?= csrf_field() ?>
                  <!-- <div class="row">
                  ...
                  <!-- <div class="row">
                    <div class="col-md-12">
                      <div class="form-group" style="">
                        ...
                        <textarea class="form-control textarea" style="height: 500px;" placeholder="Write your article here ... "></textarea>
                      </div>
                    </div>
                  </div> -->
                  ...
                  <div class="row">
                    <div class="update ml-auto mr-auto">
                      <button type="submit" class="btn btn-success btn-round">Post Slider</button>
                    </div>
                  </div>
                </form>
              </div>
